...
<?php
// shows data from origin table of all cities and countries
if(isset($_POST["view"])){
...
// adds cities and countries into origin table then displays data to ensure it worked
if(isset($_POST["add"])){
...
// search function that displays table cities depending on selected country
